 ...
 * 
 */
@WebServiceClient(name = "BankServiceService", targetNamespace = "http://fastmoney.ws.dtu/", wsdlLocation = "http://fastmoney-00.compute.dtu.dk:80/BankService.wsdl.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://fastmoney-00.compute.dtu.dk:80/BankService.wsdl.xml");
